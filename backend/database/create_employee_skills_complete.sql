-- Script SQL complet pour créer les tables de compétences des employés
-- Exécuter ce script dans MySQL: mysql -u root -p < database_name < create_employee_skills_complete.sql

-- Créer d'abord la table employees de base si elle n'existe pas
...
-- Insérer quelques employés de démonstration si la table est vide
INSERT IGNORE INTO employees (id, prenom, nom, email, password, role) VALUES
(1, 'Admin', 'User', 'admin@sit-erp.com', 'password123', 'admin'),
(2, 'Manager', 'User', 'manager@sit-erp.com', 'password123', 'manager'),
